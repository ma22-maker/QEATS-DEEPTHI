...
public class RestaurantServiceMockitoTestStub {
 ...
 public void testFindNearbyWithin5km() throws IOException {
  ...
  GetRestaurantsResponse allRestaurantsCloseBy = restaurantService
    ...
    .findAllRestaurantsCloseBy(new GetRestaurantsRequest(20.0, 30.0), LocalTime.of(3, 0)); // LocalTime.of(19,00));
 ...
 public void testFindNearbyWithin3km() throws IOException {
  ...
  lenient().when(restaurantRepositoryServiceMock.findAllRestaurantsCloseBy(eq(20.0), eq(30.2),

    eq(LocalTime.of(5, 0)), eq(5.0))).thenReturn((restaurantList1));




  lenient().when(restaurantRepositoryServiceMock.findAllRestaurantsCloseBy(eq(21.0), eq(31.1),

    eq(LocalTime.of(19, 0)), eq(3.0))).thenReturn((restaurantList2));
  ...
  GetRestaurantsResponse allRestaurantsCloseByOffPeakHours = restaurantService
    ...
    .findAllRestaurantsCloseBy(new GetRestaurantsRequest(20.0, 30.2), LocalTime.of(5, 0));
